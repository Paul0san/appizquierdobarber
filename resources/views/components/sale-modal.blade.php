    ...
    <div
              ...
              {{-- <div class="mt-4 text-sm">
                ...
                <div class="mt-2">
                  ...
                  <button
                  wire:click="addService({{$servicio->id}})"
              ...
              <div class="mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">
                  Productos y/o servicios agregados
                </span>
                <div class="mt-2">

                  @forelse ($orderProducts as $index => $item)
                    <label class="items-center text-gray-600 dark:text-gray-400">
                      <ul class="list-none md:list-disc">
                        <li class="text-sm" value="{{$item['service_id']}}">{{$item['service_name']}}</li>
                      </ul>
                    </label>
                    
                  @empty
                    <label class="inline-flex items-center text-gray-600 dark:text-gray-400">
                      <span>No hay productos o servicios agregados</span>
                    </label>
                  @endforelse
