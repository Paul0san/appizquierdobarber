<div>
    ...
    <div class="mt-4 mb-6">
        ...
        >
        Registrar nuevo barber
        </p>
        
        <!-- Modal description -->
        <p class="text-xs text-gray-700 dark:text-gray-400">
        Añade un correo real, en un futuro los necesitaremos
        </p>
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" >
              ...
              <label class="block text-sm mb-2">
                ...
                />
                @error('name')
                    <span class="mb-1 font-semibold text-red-600">
                        {{$message}}
                    </span>
                @enderror
              </label>
    ...
    >
        <span wire:loading wire:target="addBarber" class="text-white">Cargando . . .</span>
