                ...
                <tr class="text-gray-700 dark:text-gray-400">
                  <td class="px-4 py-3">
                    <div class="flex items-center text-sm">
                      ...
                      <div>
                        <p class="font-semibold items-center">{{$servicio->service_name}}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td class="px-4 py-3 self-center">
                    <div class="flex items-center justify-center text-sm">
                      ...
                      wire:click="$emit('deleteConfirm',{{$servicio->id}})"
...
@push('js')
  ...
  <script>
    Livewire.on('deleteConfirm', serviceId =>{
      Swal.fire({
        title: '¿Estás seguro?',
        text: "Se borrarán todos los registros asociados",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
          Livewire.emitTo('services','deleteService', serviceId)
        }
      })
    });
  </script>
